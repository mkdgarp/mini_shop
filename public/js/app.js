...
function render(_ctx, _cache) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", null, " aasdasasd asd ");
}
...
/* harmony import */ var pinia__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! pinia */ "./node_modules/pinia/dist/pinia.esm-bundler.js");
...
var warnHandler = function warnHandler(msg, vm, trace) {
  // do nothing
};
(0,vue__WEBPACK_IMPORTED_MODULE_0__.createApp)(_components_App_vue__WEBPACK_IMPORTED_MODULE_2__["default"]).use(pinia).use((_router__WEBPACK_IMPORTED_MODULE_1___default()))
//   .use(VueSweetalert2)
.mount('#vueapp').config.warnHandler = warnHandler;
...
/* harmony export */   "PiniaPlugin": () => (/* binding */ PiniaPlugin),
...
function createSetupStore($id, setup, options = {}, pinia, hot) {
    ...
    const partialStore = {
        ...
        $subscribe(callback, options = {}) {
            /* istanbul ignore if */
            if (( true) && typeof options === 'boolean') {
            ...
            options.detached);
            const stopWatcher = scope.run(() => (0,vue_demi__WEBPACK_IMPORTED_MODULE_0__.watch)(() => pinia.state.value[$id], (state, oldState) => {
                if (isListening) {
                    callback({
                        storeId: $id,
...
/* harmony import */ var C_Users_Champ_Documents_GitHub_mini_shop_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");

const script = {}

;
const __exports__ = /*#__PURE__*/(0,C_Users_Champ_Documents_GitHub_mini_shop_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_1__["default"])(script, [['render',_App_vue_vue_type_template_id_332fccf4__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/App.vue"]])
/* hot reload */
if (false) {}
